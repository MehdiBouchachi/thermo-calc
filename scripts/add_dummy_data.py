#!/usr/bin/env python
# thermocalc/scripts/add_dummy_data.py
"""
Populate database with dummy buildings for testing.
Creates 3 sample buildings with components and calculations.
...
def add_dummy_data():
    """
    Insert 3 dummy buildings with components and calculations.
    """
    config = Config()
